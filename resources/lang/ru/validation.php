...
$matchFio = 'Поле «:attribute» не должно содержать латинские и специальные символы, теги и цифры';
$teg = 'Поле «:attribute» не должно седержать тегов <></>';
...
return [
    ...
    */
    ...
    'images'               => 'Поле :attribute должно быть изображением',
    ...
    */
    ...
    'custom' => [
        ...
        'phone' => [
            'required' => $required,
            'max'   => $max,
            'regex' => 'Поле «:attribute» должно иметь форма: 375(00)0000000',
        ],
        'address' => [
            'required' => $required,
            'max' => $max,
