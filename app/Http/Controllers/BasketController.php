...
class BasketController extends Controller {
    ...
    public function index() {
        ...
        if(auth()->user()){
            ...
            $amount = $userAmount->endPrice($amount);
            return view('basket.index', compact('products', 'amount','discount','userAmount'));
        }else{

            return view('basket.index', compact('products', 'amount','discount'));
        }
    }
    ...
    public function checkout(Request $request) {
        ...
        return view('basket.checkout', compact('profile'));
    }
    ...
    public function saveOrder(Request $request) {
        ...
        foreach ($this->basket->products as $product) {
            if(auth()->user()){
                $price = $userAmount->endPrice($product->price);
                $cost = $userAmount->endPrice($product->price) * $product->pivot->quantity;
            }else{
                $price =  $product->price;
