...
Route::group([
    ...
    Route::get('product/comment/{product}','CommentController@show')
        ->name('product.comment'); 

    Route::post('product/comment/create','CommentController@create')
...
Route::group([
    ...
    Route::get('comment/count','CommentController@showCount')
    ->name('product.comment.count'); 

    Route::get('order/count','OrderController@countNewOrder')
    ->name('order.count');
